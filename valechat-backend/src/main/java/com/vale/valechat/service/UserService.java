...
import com.vale.valechat.model.vo.WorkSpaceListVo;
import com.vale.valechat.model.vo.WorkSpaceVo;
...
public interface UserService extends IService<User> {
    ...
    ChatListVO getUnreadChatList(UserChatListRequest userChatListRequest);
