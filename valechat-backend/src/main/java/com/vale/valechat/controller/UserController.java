...
//            return ResultUtils.error(ErrorCode.PARAMS_ERROR);
    ...
    public BaseResponse<ChatListVO> getUnreadChatList(@RequestBody UserChatListRequest userChatListRequest, HttpServletRequest request){
        if (userChatListRequest == null){
            throw new BusinessException(ErrorCode.PARAMS_ERROR);
        }
        long userId = userChatListRequest.getUserId();
        ...
        ChatListVO chatListVO = userService.getUnreadChatList(userChatListRequest);
        return ResultUtils.success(chatListVO);
    }
